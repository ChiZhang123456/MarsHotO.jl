...
# The ion plus the recombining electron has the mass of two neutral O atoms.
# This identity makes event-level momentum conservation exact in the
# nonrelativistic reaction kinematics used here.
const O2P_MASS_KG = 2O_MASS_KG - ELECTRON_MASS_KG
